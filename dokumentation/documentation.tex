...
%1. Eine statische Web-Seite als Startpunkt der Anwendung.
%2. Ausgelagerte REST APIs für dynamisches Verhalten der Anwendung.
%3. Benutzerverwaltung mit expliziten Authentifizierungs- und Autorisierungsverwaltung
%4. Die Daten der Anwendung sollen in einer Datenbank verwaltet werden. Die SQL und
%NoSQL Datenbanken sollen dabei passend eingesetzt werden.
%5. Die Anwendung soll mit heterogenen Daten umgehen können. Zusätzlich zu den
...
%6. Die Anwendung muss horizontal skalierbar sein. (Begründung!)
...
Unsere Projektanforderungen umfasst einen klassischen Aufbaue eines Web Projektes. //
...
\\
Die auf einer klassischen Serverumgebung einfach mögliche vertikale Skalierung stößt schnell auf ihre Grenzen. Früher oder später wird die Datenbank in jedem System der Flaschenhals werden und diese dann horizontal zu skalieren ist meist mit großen strukturellen und/oder Architektur- Änderungen verbunden.

\section{Vorteile Infrastruktur}
Eine Umsetzung in AWS-Services bringt ein Umdenken mit sich. Jeder Teil des Services wird in eigenen Teil gesplittet. Rechner, Speicher, Datenbank, Authentifizierung, Domainverwaltung sogar einzelne Funktionen liegen einzeln in AWS vor. Dadurch ist eine beliebige Skalierung überhaupt möglich. \\
...
Das Hauptproblem von Anwendungen, die erfolgreich von vielen Nutzern genutzt wird ist die Skalierung. Diese ist meist nur noch mit großen strukturellen Änderungen möglich.
\subsection{Plattform / Laufzeitumgebung}
...
\subsection{Speicher und Datenbank}
...
@TODO: "DB Zugriff?" Also das Problem mit dem Sachen einzeln holen.
%QUELLE DYNAMODB
%https://aws.amazon.com/de/dynamodb/
\section{Vorteile Sicherheit}
