...
\end{lstlisting}
\bigskip
\noindent Außerdem wird eine Policy erstellt, um Logs und S3 Objekte zu schreiben und XRAYs verfolgen zu können.\\
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.35]{AddFile-Szenario.png} 
\caption{Ablauf eines Fileuploads.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[scale=0.35]{DeleteWindow-Szenario.png}
...
Um die etwaigen Kosten abzuschätzen haben wie den \textit{AWS-Gesamtbetriebskostenrechner} bedient \cite{AWSc}.
...
Für die Berechnung wurde der AWS Simply Monthly Calculator Rechner bedient. Für Lambda wurde folgender Rechner genutzt \cite{dashbird}.
\\
